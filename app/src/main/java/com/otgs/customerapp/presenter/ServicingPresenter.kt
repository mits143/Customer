...
class ServicingPresenter : ServicingView.MainPresenter {

    var context: Context? = null
    var mainView: ServicingView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ServicingView.MainView?) {
