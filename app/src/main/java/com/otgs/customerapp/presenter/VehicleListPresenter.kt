...
class VehicleListPresenter : VehicleListView.MainPresenter {

    var context: Context? = null
    var mainView: VehicleListView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: VehicleListView.MainView?) {
