...
import com.otgs.customerapp.presenter.EditVehiclePresenter
...
import com.otgs.customerapp.view.EditVehicleView
...
class EditVehicleActivity : AppCompatActivity(), EditVehicleView.MainView {

    var presenter: EditVehiclePresenter? = null
    ...
    fun init() {
        if (intent.extras != null) {
            Vehicle_ID = intent.extras!!.getInt("Vehicle_ID")
        }
        presenter = EditVehiclePresenter(this, this)
        presenter!!.loadVehicleDetailsData(
        ...
        spinVehicleType?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                presenter!!.loadVehicleSubTypeData(
                    sessionManager.getToken(this@EditVehicleActivity)!!,
    ...
    override fun onSuccessVehicleType(responseModel: Response<VehicleTypeResponse>) {
        if (responseModel.body() != null) {
            ...
            for (i in vehicleTypeList!!.indices) {
                if (vehicleTypeList!![i].vehicle_type_id == vehicle_type
                ) {
                    spinVehicleType.setSelection(vehicleTypeList!![i].vehicle_type_id)
                }
            }
    ...
    override fun onSuccessVehicleSubType(responseModel: Response<VehicleSubTypeResponse>) {
        if (responseModel.body() != null) {
            ...
            for (i in vehicleSubTypeList!!.indices) {
                if (vehicleSubTypeList!![i].vehicle_subtype_id == vehicle_sub_type) {
                    spinVehicleSubType.setSelection(vehicleSubTypeList!![i].vehicle_subtype_id)
                }
            }
    ...
    override fun onSuccessVehicleBrand(responseModel: Response<VehicleBrandResponse>) {
        if (responseModel.body() != null) {
            ...
            for (i in vehicleBrandList!!.indices) {
                if (vehicleBrandList!![i].vehicle_brand_id == vehicle_brand) {
                    spinVehicleBrand.setSelection(vehicleBrandList!![i].vehicle_brand_id)
                }
            }
    ...
    override fun onSuccessVehicleDetail(responseModel: Response<VehicleDetailResponse>) {
        if (responseModel.body() != null) {
            vehicle_type = responseModel.body()!!.details.vehicle_type_id
            vehicle_sub_type = responseModel.body()!!.details.vehicle_sub_type_id
            vehicle_brand = responseModel.body()!!.details.vehicle_brand_id
            edtVehicleNumber.setText(responseModel.body()!!.details.vehicle_number)

            if (responseModel.body()!!.details.List.size > 0) {
                registration_paper.clear()
                insurance.clear()
                other.clear()
                for (i in responseModel.body()!!.details.List.indices) {
                    if (TextUtils.equals(
                            responseModel.body()!!.details.List[i].documentName,
                            "registration"
                        )
                    ) {
                        registration_paper.add(Uri.parse(IMAGE_URL + responseModel.body()!!.details.List[i].imageUrl))
                    }
                    ...
                    if (TextUtils.equals(
                        ...
                        insurance.add(Uri.parse(IMAGE_URL + responseModel.body()!!.details.List[i].imageUrl))
                    }
                    ...
                    if (TextUtils.equals(
                        ...
                        other.add(Uri.parse(IMAGE_URL + responseModel.body()!!.details.List[i].imageUrl))
                    }
                }
                regAdapter!!.notifyDataSetChanged()
                insAdapter!!.notifyDataSetChanged()
